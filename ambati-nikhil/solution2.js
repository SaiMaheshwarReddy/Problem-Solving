...
let getAgeDetails = (arr) => {
    let agesArray = []
    let count = 0
    for(let item of arr){ 
     // let mobile = item.slice(0,10)
     // let gender = item.slice(10,11)
     let age = item.slice(11,13) 
     if (age > 60){
         agesArray.push(age)
     }
    }
    count = agesArray.length
    return count
 }
 
 let array1 = ["7868190130M7522","5303914400F9211","9273338290F4010"]
 let array2 = ["1313579440F2036","2921522980M5644"]
 console.log(getAgeDetails(array1))
